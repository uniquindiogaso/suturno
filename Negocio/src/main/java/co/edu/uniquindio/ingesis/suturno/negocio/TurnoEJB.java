...
<<<<<<< HEAD
	 ...
	 *            id del empleado
	 * @param fInicio
	 *            fecha de inicio de los turnos
	 * @param fFin
	 *            fecha final de los turnos
	...
	public List<EmpleandoXClientesDTO> turnosAtendidosEmpleado(Date fInicio, Date fFin) {
		TypedQuery<EmpleandoXClientesDTO> query = entityManager
				.createNamedQuery(Turno.TURNOS_ATENDIDOS_EMPLEADO_ENTRE_FECHAS_AGRUPADA, EmpleandoXClientesDTO.class);
		query.setParameter("fechaInicio", fInicio);
		query.setParameter("fechaFin", fFin);
...
>>>>>>> 6d41625b293283610c2ef09fd713bf745194635b
	 ...
	 * 
	 * @param e
	 *            el empleado que no ha atendido los turnos
	 * @return la lista de turnos
	 */
	public List<Turno> turnosDisponibles(Empleado e) {
		TypedQuery<Turno> query = entityManager.createNamedQuery(Turno.TURNOS_SIN_ATENDER_POR_USUARIO, Turno.class);
	...
	/**
	 * Permite determinar los turnos en espera de cada cliente
	 * 
	 * @param c
	 *            el cliente
	 * @return la lista de turnos
	 */
	public List<Turno> turnosDeCliente(Persona c) {
